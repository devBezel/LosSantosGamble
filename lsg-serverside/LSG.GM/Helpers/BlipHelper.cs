...
namespace LSG.GM.Helpers
{
    ...
    {
        public static async Task CreateBlip(this IPlayer player, BlipModel blipModel)
        {
            await player.EmitAsync("blip:create", blipModel.PosX, blipModel.PosY, blipModel.PosZ, (int)blipModel.Blip, (int)blipModel.Color, blipModel.Size, blipModel.Name, blipModel.ShortRange, blipModel.UniqueID);
        }

        public static async Task DeleteBlip(this IPlayer player, string uniqueID)
        {
            await player.EmitAsync("blip:delete", uniqueID);
        }
